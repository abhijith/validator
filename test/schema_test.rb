...
class SchemaTest < Test::Unit::TestCase
  ...
  def test_sender
    ...
    assert_equal true, payload_valid?(s, { "sender" => "testy-test-service" })
  ...
  def test_payload_structure
    ...
    assert_equal true, payload_valid?(s, { "ts" => "-1530228282", "sender" => "testy-test-service", "message" => { "foo" => "bar", "baz" => "bang" }, "sent-from-ip" => "10.0.0.1"})
    assert_equal false, payload_valid?(s, { "ts" => "x1530228282x", "sender" => "testy-test-service", "message" => { "foo" => "bar", "baz" => "bang" }, "sent-from-ip" => "10.0.0.1"})
    assert_equal false, payload_valid?(s, { "ts" => "asdf", "sender" => "testy-test-service", "message" => { "foo" => "bar", "baz" => "bang" }, "sent-from-ip" => "10.0.0.1"})
    ...
    # message
    assert_equal true, payload_valid?(s, { "ts" => "1530228282", "sender" => "testy-test-service", "message" => { "foo" => "bar", "baz" => "bang" }, "sent-from-ip" => "10.0.0.1"})
    assert_equal true, payload_valid?(s, { "ts" => "1530228282", "sender" => "testy-test-service", "message" => { "baz" => "bang" }, "sent-from-ip" => "10.0.0.1"})
    assert_equal true, payload_valid?(s, { "ts" => "1530228282", "sender" => "testy-test-service", "message" => { "foo" => "bar" }, "sent-from-ip" => "10.0.0.1"})
    assert_equal false, payload_valid?(s, { "ts" => "1530228282", "sender" => "testy-test-service", "sent-from-ip" => "10.0.0.1"})

    # extra attribute(s) in message
    assert_equal false, payload_valid?(s, { "ts" => "1530228282", "sender" => "testy-test-service", "message" => { "foo" => "bar", "baz" => "bang", "foobar" => "invalid" }, "sent-from-ip" => "10.0.0.1"})

    # sent-from-ip
    assert_equal true, payload_valid?(s, { "ts" => "1530228282", "sender" => "testy-test-service", "message" => { "foo" => "bar", "baz" => "bang" }, "sent-from-ip" => "10.0.0.1"})
    assert_equal true, payload_valid?(s, { "ts" => "1530228282", "sender" => "testy-test-service", "message" => { "foo" => "bar", "baz" => "bang" }})
    assert_equal false, payload_valid?(s, { "ts" => "1530228282", "sender" => "testy-test-service", "message" => { "foo" => "bar", "baz" => "bang" }, "sent-from-ip" => "256.256.256.256"})
    ...
    assert_equal false, payload_valid?(s, { "ts" => "1530228282", "sender" => "testy-test-service", "message" => { "foo" => "bar", "baz" => "bang" }, "sent-from-ip" => "10.0.0.1", "priority" => 1, "sneaked-in" => true })

    # ideal payload
    assert_equal true, payload_valid?(s, { "ts" => "1530228282", "sender" => "testy-test-service", "message" => { "foo" => "bar", "baz" => "bang" }, "sent-from-ip" => "10.0.0.1", "priority" => 1 })
  end
